...
namespace Hydra.Admin.Utility.Helper
{
    public class DateTimeHelper
    {
        ...
        /// <returns></returns>
        public static DateTime UnixTimesToDateTime(long timestamp)
        {
            var start = TimeZone.CurrentTimeZone.ToLocalTime(new System.DateTime(1970, 1, 1));
        ...
        /// <returns></returns>
        public static long TimeDiffSeconds(DateTime startTime,DateTime endTime)
        {
            return Convert.ToInt64((endTime - startTime).TotalSeconds);
        }
        #endregion
    }
}
