<template>
  <div class="charts">
    <Row :gutter="16">
      <Col span="12">
        <VmChartBarLine title="充值统计" :xAxisData="dataBar1.xAxisData" :series="dataBar1.series">
        </VmChartBarLine>
      </Col>
      <Col span="12">
    ...
    <Row :gutter="16">
      <Col span="12">
        <VmChartBarLine title="日激活" :xAxisData="dataLine1.xAxisData" :series="dataLine1.series">
        </VmChartBarLine>
      </Col>
      <Col span="12">
        <VmChartBarLine title="日登录" :xAxisData="dataLine2.xAxisData" :series="dataLine2.series">
        </VmChartBarLine>
      </Col>
    </Row>
    <Row :gutter="16">
          ...
          series: [
            {
              name: '销量',
              type: 'line',
              data: [5000, 2090, 3060, 1000, 1000, 2000]
            }
          ]
        },
        dataLine2: {
